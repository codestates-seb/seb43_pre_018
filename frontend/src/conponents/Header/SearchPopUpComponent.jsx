      ...
      <SearchPopUpView onClick={(e) => e.stopPropagation()}>
        ...
        >
          <SearchPopUpTextContainer>
            <SearchType>user:1234</SearchType>{" "}
            <SearchDescription>search by author</SearchDescription>
          </SearchPopUpTextContainer>
          <SearchPopUpTextContainer>
            <SearchType> answers:0</SearchType>{" "}
            <SearchDescription>unanswered questions</SearchDescription>
          </SearchPopUpTextContainer>
        </SearchPopUpInnerContainer>
        <SearchPopUpInnerContainer>
          <Button
